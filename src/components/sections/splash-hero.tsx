...
export function SplashHero() {
  return (
    <section className="relative isolate flex min-h-svh flex-col items-center justify-center gap-12 overflow-hidden px-6 py-16 text-[var(--text-primary)] md:px-12 lg:px-20">
      <AuroraBackground />
      ...
      <div className="flex max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="mt-6 text-balance text-4xl font-semibold leading-tight text-[var(--text-primary)] sm:text-5xl">
